...
#ifndef FRICTIONQPOTFEM_UNIFORMSINGLELAYER2D_HYBRIDSYSTEM_H
#define FRICTIONQPOTFEM_UNIFORMSINGLELAYER2D_HYBRIDSYSTEM_H
...
#include "UniformSingleLayer2d_HybridSystem.hpp"
