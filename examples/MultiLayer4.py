...
system.setDriveMatrix(1.0 * np.ones((nelem)))
...
vector = system.vector()
ubar = quad.InterpQuad_vector(vector.AsElement(u))
print(vector.AsElement(u))
print(ubar[stitch.elemmap(0), :, :])
print(ubar[stitch.elemmap(1), :, :])
print(ubar[stitch.elemmap(2), :, :])
print(np.average(ubar[stitch.elemmap(0), :, :], weights=dV[stitch.elemmap(0), :, :], axis=(0, 1)))
print(np.average(ubar[stitch.elemmap(1), :, :], weights=dV[stitch.elemmap(1), :, :], axis=(0, 1)))
print(np.average(ubar[stitch.elemmap(2), :, :], weights=dV[stitch.elemmap(2), :, :], axis=(0, 1)))
