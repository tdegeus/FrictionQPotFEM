...
PYBIND11_MODULE(FrictionQPotFEM, m)
{
    ...
    py::class_<SM::System>(sm, "System")
        ...
        .def("v", &SM::System::v, "v")
        .def("a", &SM::System::a, "a")
        .def("mass", &SM::System::mass, "mass", py::return_value_policy::copy)
        .def("damping", &SM::System::damping, "damping", py::return_value_policy::copy)
        ...
        .def("stiffness", &SM::System::stiffness, "stiffness", py::return_value_policy::copy)
        .def("vector", &SM::System::vector, "vector", py::return_value_policy::copy)
        .def("quad", &SM::System::quad, "quad", py::return_value_policy::copy)
        .def("material", &SM::System::material, "material", py::return_value_policy::copy)
